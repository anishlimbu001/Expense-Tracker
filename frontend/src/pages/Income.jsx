...
import { Plus, Download, Eye, Calendar, TrendingUp, Filter, BarChart2, Wallet2, BanknoteArrowUp} from "lucide-react";
...
import { incomeStyles as styles } from "../assets/styles.js";
    ...
    <div className={styles.chartHeight}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip
            formatter={(value) => [
              `रु${Math.round(value).toLocaleString()}`,
              "Income",
            ]}
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.summaryGrid}>
        <FinancialCard
          ...
          label="Total Income"
          value={`रु${Number(totalIncome || 0).toLocaleString()}`}
          additionalContent={
        ...
        <FinancialCard
          ...
          value={`रु${Number(averageIncome || 0).toLocaleString()}`}
          additionalContent={
            <div className="mt-2 text-xs text-gray-500 flex items-center">
      ...
      <div className={styles.listContainer}>
        <div className={styles.header}>
          <h3 className={styles.sectionTitle}>
            <Wallet2 className="w-5 h-5 md:w-6 md:h-6 text-green-500" />
            Income Transactions
            <span className="text-sm text-gray-500 font-normal">
              {" "}
              ({timeFrameRange.label})
          ...
          {filteredTransactions.length === 0 && (
            <div className={styles.emptyStateContainer}>
              <div className={styles.emptyStateIcon}>
                <BanknoteArrowUp className="w-6 h-6 md:w-8 md:h-8 text-green-400" />
              </div>
