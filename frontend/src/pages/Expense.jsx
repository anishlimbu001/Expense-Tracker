...
import {Plus, Download, Eye, Calendar, TrendingDown, Filter, BarChart2, BanknoteArrowDown} from "lucide-react";
...
import { expensePageStyles as styles } from "../assets/styles.js";
    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardsGrid}>
        <FinancialCard
          icon={
            <div className={styles.iconOrange}>
              <BanknoteArrowDown className={`w-5 h-5 ${styles.textOrange}`} />
            </div>
          }
        ...
        <FinancialCard
          ...
          value={`रु${averageExpense.toLocaleString()}`}
          additionalContent={
            <div className="mt-2 text-xs text-gray-500 flex items-center">
        ...
        <div className={styles.chartHeight}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
              ...
              />
              <Tooltip
                formatter={(value) => [`रु ${Math.round(value).toLocaleString()}`, "Expense"]}
      ...
      <div className={styles.transactionsContainer}>
        <div className={styles.transactionsHeader}>
          <h3 className={styles.transactionsTitle}>
            <BanknoteArrowDown className="w-6 h-6 -mx-1.5 lg:-mx-2 md:mx-0 text-orange-500" />
          ...
          {filteredTransactions.length === 0 && (
            <div className={styles.emptyState}>
              <div className={styles.emptyStateIcon}>
                <BanknoteArrowDown className="w-8 h-8 text-orange-400" />
              </div>
